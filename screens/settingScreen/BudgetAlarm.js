...
const BudgetAlarm = () => {
    ...
    return (
      <View style={styles.container}>
        <Text style={{fontSize:20, marginBottom:40,color:'white',padding:10, borderRadius: 10, backgroundColor:"#e9664e"}}>예산 알람 설정</Text>
        ...
        <View style={{flexDirection: 'row', marginBottom:60}}>
          <Text style={{paddingRight: 25, fontSize:20, paddingTop:10}}>시기</Text>
          <View>
            <SelectDropdown
              data={percent}
